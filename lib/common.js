...
exports.sendKafkaMessage = (aTopic, userId, url, productId, productPrice) => {   
    producer.connect()                                                   
    producer.send({                                                      
        topic: aTopic,                                                   
        messages: [ 
            ...
            { key: 'URL', value: url },                                  
            { key: 'Product ID', value: productId },                     
            { key: 'Price', value: productPrice },                       
            { key: 'Timestamp', value: JSON.stringify(new Date()) },     
        ],                                                               
    })                                                                   
}
